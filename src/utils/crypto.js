...
*
* The encryption scheme used is the Elliptic Curve Integrated Encryption Scheme (ECIES). We will import these from bitcore libraries.
*/
...
// Encoding - RLP
// We want to encode before passing through blockchain
// We build a buffer array and RLP encode it
let encodeEncryptedJSON = function(_encryptedJSON){
  var encoded = [];
...
let decodeEncryptedJSON = function (_encodedEncryptedJSON){
  var decodedJSON = {};
